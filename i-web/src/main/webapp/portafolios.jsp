...
<li class="dropdown">
	...
	<div class="main work-page">
	    ...
	    <a href="#" onclick="window.open('/i-web/crearPortafolio.jsp', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=500, height=350'); return false;" style="text-decoration:none">Crear nuevo portafolio</a><br><br>
