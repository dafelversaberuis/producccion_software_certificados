...
<br/>
<a href="#" onclick="window.open('/i-web/crearAdministrador.jsp', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=500, height=350'); return false;" style="text-decoration:none">Crear un(a) nuevo(a) administrador(a)</a><br><br>
