...
<body>
	<%
		...
		if(hdnGuardarPublicacion!=null && hdnGuardarPublicacion.equals("1")){
			...
			datos = new String[Integer.parseInt(numero_personas)][11];
	...
	<%
		...
		List<Certificado> tiposCertificados = bAdministrarPublicaciones
				.getTiposCertificados();

		List<Object[]> clientes = bAdministrarPublicaciones
				.getFinanciadores();
	%>
	<form name="form1" id="form1" method="post">
		...
		<!--HEADER-->
		<header>
		<img src="home_files/logo.png" alt="logo" width="220px" height="auto">
		<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="post">
							...
							<div class="content">
								<h4>Ingreso de personas a través de archivo excel</h4>
								<br />
								<div align="left">
									...
									<h5>
										<span style="color: blue"> Paso 1:</span> Descargar plantilla
										y diligeniciar datos dentro de este archivo según
										instrucciones: <a href="plantilla_capacitados.csv"
											target="_blank"><span style="color: blue">Descargar
												plantilla aquí</span></a>
									</h5>

									<br />
									<h5>
										<span style="color: blue"> Paso 2:</span> Diligenciar los
										siguientes datos:
									</h5>
									<br />
									<table width="100%" border="0" cellspacing="2" cellpadding="2">
										<tr>
											...
											<td>Formailismo<span style="color: red; font-size: 20px">*</span>:
											</td>
											<td><input id="etiqueta_capacitacion"
												style="width: 300px" name="etiqueta_capacitacion"
												type="text" value="Asistió al" /></td>
											<td>Cliente:</td>
										...
										<tr>
											...
											<td>Ciudad/Departamento donde se dictó<span
												style="color: red; font-size: 20px">*</span>:
											</td>
											<td><input id="ciudad_curso" name="ciudad_curso"
												style="width: 300px" type="text" value="" /></td>
										</tr>
									...
									<tr>
										...
										<tr>
											...
											<td>Fecha máx disponibilidad certificado<span
												style="color: red; font-size: 20px">*</span>:
											</td>
									...
									<br />
									<h5>
										<span style="color: blue"> Paso 3:</span> Luego de tener el
										excel diligenciado los datos en pantalla y los datos del
										archivo excel, presione el botón continuar
									</h5>
									<br />
									<div align="center">
										<input type="button" value=" Continuar "
											onclick="validarLoteExcel();" />
									</div>
								...
								<br />
								<span id="detalleFechas"></span> <input name="hdnUs" id="hdnUs"
									type="hidden" value="<%=bUsuario.getIdUsuario()%>" />
		...
		<center>
			<div class="container">
				...
				<p>
					Contacto: directorcomercial@isolucionesltda.com<br>(+57) 1
					6960495 <br>Diseñado por: quimerapps.com
				</p>
			</div>
		</center>
		</footer>
