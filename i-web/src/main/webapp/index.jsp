						...
						<div class=" et_pb_row et_pb_row_0">
							...
							<div class="et_pb_column et_pb_column_4_4  et_pb_column_0">
								...
								<div
									...
									<p>A través de nuestra empresa puede descargar sus certificados,
										normas, memorias, entre otros, de los cursos, capacitaciones,
										y/o diplomados que ha realizado. Es simple, sólo escriba su
										<b>documento de identificación y presione consultar</b>.</p>
									<br /><br /> 
									<center>
										<table border="0" style="width: 70%">
											<tr>
												<td style="vertical-align: middle;">
													...
													</h4> <input name="documento_certificado" type="text"
													id="documento_certificado"
													class="validate['required'] documento_certificado"
													placeholder=" "
												...
												<td style="vertical-align: middle;">
													<div class="et_pb_blurb_content">
														<div>
															<a href="#"
																onclick="validarLoteConsulta2(); return false;"><span
																class="et-waypoint et_pb_animation_top et-pb-icon-circle"
																style="color: #ffffff; background-color: #910b0b; font-size: 20px">Consultar</span></a>
														</div>
													</div>
												</td>
											</tr>
									...
									<span id="detalleLote" style="text-align: center"></span> <br />
									<br />
