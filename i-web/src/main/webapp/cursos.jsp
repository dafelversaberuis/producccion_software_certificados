			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="post">
						...
						<div class="content">
							<h4>Temas/eventos/cursos y memorias</h4>

						
<br/><br/>
<a href="#" onclick="window.open('/i-web/crearCurso.jsp', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=650, height=350'); return false;" style="text-decoration:none">Crear nuevo curso/tema/evento</a><br><br>
