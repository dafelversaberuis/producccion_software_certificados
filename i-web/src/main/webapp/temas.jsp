			...
			<div class="row">  
				<div class="col-md-12">
					...
					<div class="post">
						...
						<div class="content">
							<h4>Memorias del curso/evento/tema: <%=cursoX[1] %></h4>

<br/><br/>
<a href="#" onclick="window.open('/i-web/crearTema.jsp?id=<%=curso %>', 'popup', 'toolbar=no, menubar=no, scrollbars=no, resizable=no, width=500, height=350'); return false;" style="text-decoration:none">Crear nueva memoria al curso/tema/evento</a><br><br>
